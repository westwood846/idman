def calc_similarity(w1, w2):
    return max([len(longest_common_leading_substring(w1,w2)),len(longest_common_trailing_substring(w1,w2))])/max([len(w1),len(w2)])

##
# this methods are from https://en.wikibooks.org/wiki/Algorithm_Implementation/Strings/Longest_common_leading/trailing_substring#Python
